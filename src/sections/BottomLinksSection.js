...
const BottomLinksSection = () => {
  return (
   ...
   <h2 class="rubrik">Customer Support</h2>
   ...
   <a href="#"><button className="payment"><i class="fa-light fa-money-check"></i></button></a>
   ...
   <div className="third-info">
       <a href="#"><button class="delivery"><i class="fa-light fa-truck"></i></button></a>    
